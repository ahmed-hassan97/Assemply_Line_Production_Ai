...
def Telemetry_Electronics():
    ...
    left_column.button('choose Robot Name' , key = 1)

    # Or even better, call Streamlit functions inside a "with" block:
    with left_column:
        chosen_machine1 = st.radio(
            'Robot Name',
            ("Circular Cutting Robot", "Straight cutting Robot" ,"Hole Cutting Robot") , key = 2)
        st.write(f"You Choose   {chosen_machine1} ")


    middle_column.button('choose Robot Name' , key = 3)

    # Or even better, call Streamlit functions inside a "with" block:
    with middle_column:
        chosen_machine2 = st.radio(
            'Robot Name',
            ("Circular Cutting Robot", "Straight cutting Robot" , "hole Cutting Robot" ) , key = 4)
        st.write(f"You Choose   {chosen_machine2} ")        


    right_column.button('choose Robot Name' , key = 23)
    # Or even better, call Streamlit functions inside a "with" block:
    with right_column:
        chosen_machine21 = st.radio(
            'Robot Name',
            ("Circular Cutting Robot", "Straight cutting Robot" , "hole Cutting Robot" ) , key = 24)
    ...
    with last_column:
        ...
        chosen_kind1 = st.radio(
            'Robot connection',
            ("Parallel" , ) , key = 14)
        st.write(f"You Choose connection Between Robot {chosen_kind1} ")   
...
def Steering_Control():  
    ...
    left_column.button('choose Robot Name' , key = 11)
    ...
    with left_column:
        ...
        chosen_machine3 = st.radio(
            'Robot Name',
            ("Turret Lathe Robot", "Vertical Lathe Robot") , key = 21)
        st.write(f"You Choose  {chosen_machine3} ")


    middle_column.button('choose Robot Name' , key = 31)
    ...
    with middle_column:
        ...
        chosen_machine4 = st.radio(
            'Robot Name',
            ( "Turret Lathe Robot", "Vertical Lathe Robot") , key = 41)
        st.write(f"You Choose   {chosen_machine4} ")        

    right_column.button('choose connection Between Robot' ,key = 51)
    ...
    with right_column:
        ...
        st.write(f"You Choose connection Between Robot {chosen_kind2} ")   
...
def Thrust_control():
    ...
    with left_column:
        ...
        chosen_machine3 = st.radio(
            'Robot Name',
            ("3D Cutting lisar Robot", "Strapping Robot") , key = 21)
        st.write(f"You Choose  {chosen_machine3} ")


    middle_column.button('choose Robot Name' , key = 301)

    # Or even better, call Streamlit functions inside a "with" block:
    with middle_column:
        chosen_machine4 = st.radio(
            'Robot Name',
            ( "3D Cutting lisar Robot", "Strapping Robot") , key = 41)
        st.write(f"You Choose {chosen_machine4} ")        

    right_column.button('choose Robot Name' ,key = 501)
